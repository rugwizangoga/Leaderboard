...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _consumeAPI_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./consumeAPI.js */ \"./src/consumeAPI.js\");\n\n\n\nlet gameId = '';\nfetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games', {\n  method: 'POST',\n  body: JSON.stringify({\n    name: 'fantasy football',\n  }),\n  headers: {\n    'Content-type': 'application/json; charset=UTF-8',\n  },\n})\n  .then((response) => response.json())\n  .then((json) => {\n    const res = json.result;\n    gameId = res.slice(14, res.lastIndexOf(' '));\n  });\n\nconst refresh = document.querySelector('.refresh');\n\nrefresh.addEventListener('click', () => {\n  (0,_consumeAPI_js__WEBPACK_IMPORTED_MODULE_1__.refreshTable)(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${gameId}/scores`);\n});\n\nconst addscore = document.getElementById('submit');\nconst name = document.getElementById('name');\nconst score = document.getElementById('score');\n\naddscore.addEventListener('click', () => {\n  if (name.value !== '' && score.value !== '') {\n    (0,_consumeAPI_js__WEBPACK_IMPORTED_MODULE_1__.addNewScore)(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${gameId}/scores`, name.value, score.value);\n    document.forms[0].reset();\n  }\n});\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
